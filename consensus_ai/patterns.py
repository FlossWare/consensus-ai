"""Pluggable multi-model execution patterns for consensus-ai.

Provides three execution pattern implementations:
...
from consensus_ai.types import ChatMessage, ChatResponse, PatternResult

if TYPE_CHECKING:
    from consensus_ai.protocol import LLMBackend, ModelRouter
